...
<section class="view">
    ...
    <div class="content">
        ...
        <div class="view--table">
            ...
            <div class="comment--box">
                ...
                <div class="comment--list">
                    <ul>
                        <li class="comment--item">
                            <div class="comment-item--header">
                                ...
                                <div class="comment-item--util">
                                    <button class="icon-button modify-button" title="수정"><span class="hide">수정</span></button>
                                    <button class="icon-button delete-button" title="삭제"><span class="hide">삭제</span></button>
                                </div>
                            </div>
                            <!-- 댓글 내용 -->
                            ...
                            <!-- <div class="comment-item--content comment-item--modify">
                                <div class="comment-write">
                                    <textarea class="com-input"></textarea>
                                    <div class="comment-write--util">
                                        <button class="file-button"><span class="hide">파일 첨부</span></button>
                                        <button class="button primary-button">등록</button>
                                    </div>
                                </div>
                            </div> -->
                            <!-- //댓글 수정 -->
                        ...
                        <li class="comment--item">
                            <div class="comment-item--header">
                                <div class="comment-item--info">
                                    <span class="com-name">홍길서 팀장</span>
                                    <span class="com-date">2021-11-30</span>
                                </div>
                            </div>
                            <!-- 댓글 내용 -->
                        ...
                        <li class="comment--item">
                            ...
                            <div class="comment-item--content comment-item--modify">
                                <div class="comment-write">
                                    <textarea class="com-input"></textarea>
                                    <div class="comment-write--util">
                                        <button class="file-button" title="파일 첨부"><span class="hide">파일 첨부</span></button>
                                        <button class="button primary-button">등록</button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="comment-write--box">
                    <div class="comment-write">
                        <textarea class="com-input" placeholder="댓글을 남겨보세요."></textarea>
                        <div class="comment-write--util">
                            <button class="file-button" title="파일 첨부"><span class="hide">파일 첨부</span></button>
                            <button class="button primary-button">등록</button>
                        </div>
        ...
        <div class="button--box">
            <button class="button primary-button">수정</button><!--
